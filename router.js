Router.configure({
    ...
    progressDelay: 250,
    title: "Tiny Gigs - Job board and developer listing just for Tiny Gigs"
});
...
Router.map(function() {
    ...
    this.route('jobs', {
        path: '/jobs',
        title: "Tiny Gigs - All Jobs"
    });

    this.route('myJobs', {
        path: '/myjobs',
        title: "Tiny Gigs - My Jobs",
        data: function() {
            return {
                jobs: Jobs.find({
                    userId: Meteor.userId()
    ...
    this.route('job', {
        ...
        title: function() {
            if (this.data())
                return "Tiny Gigs - " + this.data().title;
        },
        data: function() {
            return Jobs.findOne({
                _id: this.params._id
    ...
    this.route('jobNew', {
        path: '/job',
        title: "Tiny Gigs - Post a Job"
    });

    this.route('jobEdit', {
        path: '/jobs/:_id/:slug/edit',
        title: "Tiny Gigs - Edit Job Post",
        data: function() {
            return {
                job: Jobs.findOne({
                    _id: this.params._id
    ...
    this.route('profiles', {
        path: '/profiles',
        title: "Tiny Gigs - All Developers",
        subscriptions: function() {
    ...
    this.route('profile', {
        ...
        title: function() {
            if (this.data())
                return "Tiny Gigs - " + this.data().displayName() + " - " + this.data().title;
        },
        data: function() {
    ...
    this.route('profileNew', {
        path: '/profile',
        title: "Tiny Gigs - Create Developer Profile",
        onBeforeAction: function() {
    ...
    this.route('profileEdit', {
        ...
        title: "Tiny Gigs - Edit My Developer Profile",
        data: function() {
            return {
                profile: Profiles.findOne({
                    _id: this.params._id
